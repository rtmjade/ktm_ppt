...
class Ppt:
    ...
    title_dimensions = [8.25, 5.10, 13.6, 3.07]
    # subtitle1_dimensions = [4.47, 8.05, 16.46, 1.2]
    subtitle1_dimensions = [8.25, 8.05, 16.46, 1.2]
    ...
    class Slide:
        ...
        def add_header(self, text, dimensions):
            text_frame = self.add_textbox(text, dimensions, font_size=20, bold=False, halign='left', fit=(True, 20), rgb=self.pri_color)
            return text_frame
    ...
    def add_title_slide(self, title, subtitle1, subtitle2, privacy):
        ...
        title_slide.add_textbox(title,  self.title_dimensions, bold=True, rgb=(0, 0, 0), halign='left', fit=(True, 33))

        if subtitle1 is not None:
            title_slide.add_textbox(subtitle1, self.subtitle1_dimensions, font_size=18, rgb=(150, 146, 146), halign='left')

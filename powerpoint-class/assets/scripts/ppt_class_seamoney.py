...
class Ppt:
    ...
    title_dimensions = [4.08, 6.12, 17.22, 3.68] # seamoney
    # title_dimensions = [8.25, 5.10, 13.6, 3.07] # seagroup
    subtitle1_dimensions = [4.47, 9.80, 16.46, 1.2] # seamoney
    # subtitle1_dimensions = [8.25, 8.05, 16.46, 1.2] # seagroup dimension
    ...
    def add_title_slide(self, title, subtitle1, subtitle2, privacy):
        ...
        title_slide.add_textbox(title,  self.title_dimensions, bold=True, rgb=(6, 0, 131), fit=(True, 40))

        if subtitle1 is not None:
            title_slide.add_textbox(subtitle1, self.subtitle1_dimensions, font_size=18, rgb=(0, 0, 0))
